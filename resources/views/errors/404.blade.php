<x-guest-layout>
	<x-authentication-card>
		...
		<div class="text-center">
			<p class="text-sm font-semibold text-indigo-400">Error 404</p>
			<h1 class="mt-2 text-xl font-semibold text-red-400">Acceso restringido</h1>
			<p class="mt-3 text-sm leading-6 text-gray-400">
				{{ $exception->getMessage() ?: 'La pagina a la cual has querido acceder no existe o no tienes permisos para verla.' }}
			</p>
		</div>
