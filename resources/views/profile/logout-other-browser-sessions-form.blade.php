<x-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-300">
            {{ __('Si es necesario, puedes cerrar todas las demás sesiones de tu navegador en todos tus dispositivos. Algunas de tus sesiones recientes se muestran a continuación; sin embargo, esta lista puede no ser exhaustiva. Si crees que tu cuenta ha sido comprometida, también deberías actualizar tu contraseña.') }}
        </div>
        ...
        <x-dialog-modal wire:model.live="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Ingresa tu contraseña para confirmar que deseas cerrar tus otras sesiones del navegador en todos tus dispositivos.') }}
