...
class CartasCesponsivasController extends Controller
{
    ...
    {
        return view('admin.cartasresponsivas.index');
    }
    ...
    {
        return view('admin.cartasresponsivas.create');
    }
    ...
    public function show($id)
    {
        try {
            ...
            return view('admin.cartasresponsivas.show', compact('responsiva'));
        } catch (\Exception $e) {
    ...
    {
        return view('admin.cartasresponsivas.edit', compact('id'));
    }
